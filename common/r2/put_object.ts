...
export async function putObject(opts: { bucket: string, key: string, body: AwsCallBody, origin: string, region: string, cacheControl?: string, contentDisposition?: string, contentEncoding?: string, contentLanguage?: string, expires?: string, contentMd5?: string }, context: AwsCallContext): Promise<Response> {
    ...
    if (typeof contentDisposition === 'string') headers.set('cache-disposition', contentDisposition);
