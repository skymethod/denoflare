...
export async function getObject(opts: GetObjectOpts, context: AwsCallContext): Promise<Response> {
...
async function getOrHeadObject(method: 'GET' | 'HEAD', opts: GetObjectOpts | HeadObjectOpts, context: AwsCallContext): Promise<Response> {
