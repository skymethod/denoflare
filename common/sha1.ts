// inline a Sha1 implementation for when a sync sha1 is absolutely required (i.e. can't use subtle.crypto.digest)
// adapted from https://deno.land/std@0.119.0/hash/sha1.ts
