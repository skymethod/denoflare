...
function dumpHelp() {
    const lines = [
        ...
        '',
        'USAGE:',
        '    deno run --allow-net examples/webtail-worker/cli.ts [FLAGS] [OPTIONS] [--] build',
        '    deno run --allow-net --allow-read examples/webtail-worker/cli.ts [FLAGS] [OPTIONS] [--] b64 <path>',
        '',
        'FLAGS:',
