...
import { isTailMessageAlarmEvent, isTailMessageEmailEvent, isTailMessageGetWebSocketEvent, isTailMessageOverloadEvent, isTailMessageQueueEvent } from '../../common/tail.ts';
