...
import { isTailMessageAlarmEvent, isTailMessageEmailEvent, isTailMessageGetWebSocketEvent, isTailMessageOverloadEvent, isTailMessageQueueEvent, isTailMessageTailWorkerEvent } from '../../common/tail.ts';
