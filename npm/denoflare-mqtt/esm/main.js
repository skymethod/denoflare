class Bytes {
    ...
    static ofHex(hex1) {
        ...
        return new Bytes(new Uint8Array(hex1.match(/.{1,2}/g).map((__byte) => parseInt(__byte, 16))));
    }
    utf8() {
...
Object.defineProperty(Bytes, "EMPTY", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: new Bytes(new Uint8Array(0))
});
...
Object.defineProperty(Mqtt, "DEBUG", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: false
...
class DenoTcpConnection {
    constructor(conn) {
        Object.defineProperty(this, "completionPromise", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    constructor(ws) {
        ...
        this.completionPromise = new Promise((resolve, reject) => {
            ...
            ws.addEventListener('error', (event) => {
                ...
                reject((_a = event.message) !== null && _a !== void 0 ? _a : event);
            });
        });
...
function encodeDisconnect(message) {
    ...
    const reasonCode = (_a = reason === null || reason === void 0 ? void 0 : reason.code) !== null && _a !== void 0 ? _a : 0;
    const variableHeader = [
        reasonCode,
    ];
    return encodePacket(type, {
...
function readReason(reader, table) {
    ...
    const [name, description] = (_a = table[code]) !== null && _a !== void 0 ? _a : [
        undefined,
        undefined
    ];
    const reason = {
...
class MqttClient {
    constructor(opts) {
        ...
        Object.defineProperty(this, "onMqttMessage", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "obtainedPacketIds", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "pendingSubscribes", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: {}
        });
        Object.defineProperty(this, "savedBytes", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "maxMessagesPerSecond", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "keepAliveSeconds", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 10
        });
        Object.defineProperty(this, "pendingConnect", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "connectionCompletion", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "lastSentMessageTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "receivedDisconnect", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "clientIdInternal", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "nextPacketId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 1
    ...
    completion() {
        var _a;
        return (_a = this.connectionCompletion) !== null && _a !== void 0 ? _a : Promise.resolve();
    }
    connected() {
        ...
        while (reader.remaining() > 0) {
            ...
            if (message.type === 2) {
                if (this.pendingConnect) {
                    if (((_b = (_a = message.reason) === null || _a === void 0 ? void 0 : _a.code) !== null && _b !== void 0 ? _b : 0) < 0x80) {
                        this.clientIdInternal = (_c = message.assignedClientIdentifier) !== null && _c !== void 0 ? _c : this.clientIdInternal;
                        this.keepAliveSeconds = (_d = message.serverKeepAlive) !== null && _d !== void 0 ? _d : this.keepAliveSeconds;
                        this.reschedulePing();
    ...
    async sendMessage(message) {
        ...
        const intervalMillis = 1000 / (maxMessagesPerSecond !== null && maxMessagesPerSecond !== void 0 ? maxMessagesPerSecond : 1);
...
class Signal {
    constructor() {
        ...
        Object.defineProperty(this, "resolve_", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "reject_", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
export { MqttClient as MqttClient };
